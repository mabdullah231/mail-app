        ...
        <nav class="navbar navbar-expand-lg navbar-light p-0">
          <div class="iq-navbar-logo d-flex align-items-center justify-content-between">
            ...
            <a href="index.html" class="header-logo">
              <img
                src="/public/imagesDashboard/logo.png"
                class="img-fluid rounded-normal light-logo"
                alt="logo"
              />
              <img
                src="/public/imagesDashboard/logo-white.png"
                  ...
                  >
                    <div class="card shadow-none m-0">
                      <div class="card-body p-0">
                          ...
                          <a href="#" class="iq-sub-card">
                            <div class="media align-items-center">
                              ...
                              <div class="media-body ml-3 rtl-mr-3 rtl-ml-0">
                                <h6 class="mb-0">
                                  Barry Emma Watson
                                  <small class="badge badge-success float-right rtl-mr-1">
                                    New
                                  </small>
                                </h6>
                          ...
                          <a href="#" class="iq-sub-card">
                            <div class="media align-items-center">
                              <div class="">
                                <img
                                  class="avatar-40 rounded-small"
                                  src="/public/imagesDashboard/user/02.jpg"
                                  alt="02"
                                />
                              </div>
                          ...
                          <a href="#" class="iq-sub-card">
                            <div class="media align-items-center">
                              <div class="">
                                <img
                                  class="avatar-40 rounded-small"
                                  src="/public/imagesDashboard/user/03.jpg"
                                  alt="03"
                                />
                              </div>
                              <div class="media-body ml-3 rtl-mr-3 rtl-ml-0">
                          ...
                          <a href="#" class="iq-sub-card">
                            <div class="media align-items-center">
                              <div class="">
                                <img
                                  class="avatar-40 rounded-small"
                                  src="/public/imagesDashboard/user/04.jpg"
                                  alt="04"
                                />
                              </div>
                              <div class="media-body ml-3 rtl-ml-0 rtl-mr-3">
                          ...
                          <a href="#" class="iq-sub-card">
                            <div class="media align-items-center">
                              <div class="">
                                <img
                                  class="avatar-40 rounded-small"
                                  src="/public/imagesDashboard/user/05.jpg"
                                  alt="05"
                                />
                              </div>
                              <div class="media-body ml-3 rtl-mr-3 rtl-ml-0">
                        ...
                        >
                          <div class="dd-icon">
                            <i class="las la-arrow-right mr-0"></i>
                          </div>
                          View All
                        </a>
                      </div>
                          ...
                          <div class="profile-header">
                            ...
                            <div class="row">
                              ...
                              <div class="col-lg-6 col-md-6 col-6">
                                <div class="profile-details text-center">
                                  <a
                                    href="https://templates.iqonic.design/instadash/html/app/user-profile-edit.html"
                              ...
                              <div class="col-lg-6 col-md-6 col-6 pr-0">
                                <div class="profile-details text-center">
                                  <a
                                    href="https://templates.iqonic.design/instadash/html/app/user-account-setting.html"
                              ...
                              <div class="col-lg-6 col-md-6 col-6">
                                <div class="profile-details text-center">
                                  <a
                                    href="https://templates.iqonic.design/instadash/html/app/user-privacy-setting.html"
